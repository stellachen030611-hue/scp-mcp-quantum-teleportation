...
├── README.md
├── .gitignore
├── generate_all_results.py               # Python script to generate all outputs
...
└── others/
    └── eval_scripts/
        └── validate_results.py           # Self-validation script
```
...
1. Clone the repository
   ```bash
   git clone https://github.com/stellachen030611-hue/scp-mcp-quantum-teleportation
   cd your-repo-name
   ```
...
4. Validate the outputs (optional)
   ```bash
   python others/eval_scripts/validate_results.py
   ```
